...
public class DriveSubsystem extends SubsystemBase {
  ...
  public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative) {
    ...
    SmartDashboard.putNumber("r", rotDelivered);
    ...
    m_frontLeft.setDesiredState(swerveModuleStates[0], stopMotors);
    m_frontRight.setDesiredState(swerveModuleStates[1], stopMotors);
    m_rearLeft.setDesiredState(swerveModuleStates[2], stopMotors);
    m_rearRight.setDesiredState(swerveModuleStates[3], stopMotors);
  }
