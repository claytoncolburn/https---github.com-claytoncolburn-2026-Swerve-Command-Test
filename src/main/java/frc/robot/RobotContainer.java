...
public class RobotContainer {
    ...
    // NOTE: Only ONE drive subsystem should be active at a time (they control the
    // same hardware)
    ...
    // Alternative: Multiple Limelights for redundancy/wider coverage (uncomment and
    // modify as needed)
    //
    ...
    public RobotContainer() {
        ...
        // m_robotDrive = new YAGSLDriveSubsystem(m_visionFront, m_visionLeft,
        // m_visionRight);
        //
        // Four Limelights (front, back, left, right):
        // m_visionFront = new VisionSubsystem("limelight-front");
    ...
    private void configureButtonBindings() {
        ...
        try {
            ...
            m_driverController.leftBumper()
                    .whileTrue(AutoBuilder.pathfindThenFollowPath(path, constraints));
        } catch (Exception e) {
    ...
    public Command getAutonomousCommand() {
        // NOTE: All poses use blue origin coordinates (field origin at blue alliance
        // corner).
    ...
    public void setTeleopModeDefaultCommand() {
        ...
        m_robotDrive.setDefaultCommand(
                new RunCommand(() -> m_robotDrive.driveFieldRelative(driveInputStream.get()), m_robotDrive));
    }
    ...
    public void setTestModeDefaultCommand() {
        ...
        // m_robotDrive.setDefaultCommand(m_robotDrive.debugDriveCommand(m_driverController));
    }
